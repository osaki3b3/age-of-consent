...
${errorInfo.componentStack}`);
  ...
  // extensions/age-verification-popup/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const { ui } = useApi();
    const [isChecked, setIsChecked] = (0, import_react22.useState)(false);
    const [isEnabledInSettings, setIsEnabledInSettings] = (0, import_react22.useState)(false);
    const [isModalRejected, setIsModalRejected] = (0, import_react22.useState)(false);
    const [validationError, setValidationError] = (0, import_react22.useState)("");
    ...
    (0, import_react22.useEffect)(function() {
      ...
      fetch(
        ...
        setIsEnabledInSettings((isEnabledInSettings2) => isEnabledInSettings2 = data.checked);
      });
    });
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if (canBlockProgress2 && !isChecked && provinceCode == "NY" && isEnabledInSettings) {
        return {
          behavior: "block",
    ...
    const Modal18yoContent = function() {
      if (!isModalRejected) {
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockLayout2, { spacing: "base", padding: "base", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(TextBlock2, { inlineAlignment: "center", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", children: "To purchase these supplements in New York, we must verify your age. Are you over 18 years old?" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, {})
          ] }) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineStack2, { inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Button2,
              {
                ...
                onPress: () => {
                  ...
                  setIsChecked((isChecked2) => isChecked2 = true);
                },
                children: "Yes"
              }
            ),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Button2,
              {
                appearance: "critical",
                onPress: () => {
                  setIsChecked((isChecked2) => isChecked2 = false);
                  setIsModalRejected((isModalRejected2) => isModalRejected2 = true);
                },
                children: "No"
              }
            )
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockLayout2, { spacing: "base", padding: "base", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", children: "You need to be over the age of 18 to purchase these supplements in NY" }) }) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineStack2, { inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Button2,
            {
              onPress: () => {
                ui.overlay.close("modal-18yo");
    ...
    if (provinceCode == "NY" && isEnabledInSettings) {
      console.log("> ui: ", ui);
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockLayout2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Pressable2,
        {
          appearance: "accent",
          overlay: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
            Modal2,
            {
              id: "modal-18yo",
              padding: true,
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { inlineAlignment: "center", level: "1", children: "Verify Your Age" }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Modal18yoContent, {})
              ]
            }
          ),
          onPress: () => {
            setIsModalRejected((isModalRejected2) => isModalRejected2 = false);
          },
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Checkbox2,
            {
              ...
              children: "By selecting this box, you confirm that you are over 18 years old"
            }
          )
        }
      ) });
...
//# sourceMappingURL=age-verification-popup.js.map
